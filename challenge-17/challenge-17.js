(function () {
  ...
  */
	...
	console.log(text.replace(/Manuel Marques de Sousa/g, "Matheus Philippe"));
  ...
  */
	...
	console.log(text.replace(/[D-Za-z]/g, 0));
  ...
  */
	...
	function replaceDate(text) {
		return text.replace(regexDate, function (full, day, month, year) {
