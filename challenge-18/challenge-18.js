(function () {
    ...
    */
	...
	function formataCPF(cpf) {
		return cleanCPF(cpf).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function (regex, first, second, third, forth) {
			return first + "." + second + "." + third + "-" + forth;
		});
	}

	console.log(formataCPF("049-214 3421-1"));
	console.log(formataCPF("210.458.522-05"));
	console.log(formataCPF("735 500 794 - 22"));
	console.log(formataCPF("101.123-131x32"));
    ...
    */
	...
	let abreTag = /(<\w+>)/g;
	console.log("<div><section><blockquote>Texto <img /></blockquote></section></div>".match(abreTag));
    ...
    */
	...
	let emptyTag = /(<\w+><\/\w+>)/g;
	console.log("<div><ul><li></li><li></li><li><span></span></li></ul></div>".match(emptyTag));
	/*
