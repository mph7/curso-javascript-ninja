(function () {
    ...
    */
	function showOperationMessage(operator, num1, num2) {
		return "A operação " + num1 + " " + operator + " " + number2 + " =";
	}
    ...
    */
	operationSignal = "x";
	let x = calculator(operationSignal);
	if (x) {
		number1 = 9;
		number2 = 5;
		console.log(showOperationMessage(operationSignal, number1, number2), x(number1, number2));
	} else {
		console.log(showErrorMessage(operationSignal));
	}
})();
